  ...
  return (
    ...
    >
      ...
      <motion.div variants={copyLine} className="access-recipient">
        ...
        <DisplayText as="p" className="access-leaders">Blair Vidrine &amp; Bailey Soileau</DisplayText>
        <p className="access-company">The Apothecary Shoppe</p>
      </motion.div>

      <motion.div variants={copyLine} className="access-purpose">
        <p>A shared vision created to support your team, your people, and the standard you&apos;ve built together.</p>
      </motion.div>
